...
// Protected routes
router.post('/pets', verifyToken, allowRoles('VET', 'ADMIN'), adoptionController.listPetForAdoption);
...
router.patch('/requests/:id', verifyToken, allowRoles('VET', 'ADMIN'), adoptionController.updateRequestStatus);
